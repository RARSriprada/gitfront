            ...
            <div class="login-form">
             ...
             <form action="${pageContext.request.contextPath}/Welcome" method="GET">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col">
                            <a href="http://localhost:8080/forgot-password" class="mb-4">Forgot password?</a>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <p>Not a member? <a href="http://localhost:8080/register">Register</a></p>
                        <p>Login As Admin <a href="http://localhost:8080/demo1">Login as Admin</a></p>
                    </div>
                </form>
            </div>
        </div>
