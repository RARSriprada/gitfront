    ...
    <div class="navbar">
        <ul>
            ...
            <li>
                ...
                <div class="dropdown">
                    <a href="http://localhost:8080/Welcome1/viewcourse">View Courses</a>
                    <a href="http://localhost:8080/Welcome1/addcourse">Add Courses</a>
                    <a href="http://localhost:8080/Welcome1/deletecourse">Delete Courses</a>
                    <a href="http://localhost:8080/Welcome1/updatecourse">Update Courses</a>
                </div>
            </li>
            <li><a href="http://localhost:8080/Welcome1/grade">Grade And Progress</a></li>
            <li><a href="http://localhost:8080/Welcome1/feedback">FeedBack</a></li>
            <li><a href="http://localhost:8080/Welcome1/assignment">Assignments</a></li>
            <li><a href="http://localhost:8080/Welcome1/contact">Contact</a></li>
           <li> <a href="http://localhost:8080/demo" >Logout</a></li>
        </ul>
    </div>
