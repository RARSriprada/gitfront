...
<div class="background">
    <div class="container">
       ...
       <form action="${pageContext.request.contextPath}/demo1" method="GET">
            ...
            <p>Register As Admin <a href="http://localhost:8080/register">Register as Studnet</a></p>
            <p>or sign in :<a href="http://localhost:8080/demo">Login as Student</a></p>
        </form>
    </div>
